...
class Resource {
    constructor(name, age, greeneyes, birthday) {
        ...
        this.greeneyes = greeneyes;     //Boolean property
        this.birthday = birthday;       //Date Property
...
function add(resource, sibling) {
    ...
    creator
        .append(new ElementCreator("h3").text(resource.age))

    if (resource.greeneyes){
        creator
            .append(new ElementCreator("h2").text("Beautiful green eyes!"))
    }
    else {
        creator
            .append(new ElementCreator("h2").text("not greeneyes"))
    }
    ...
    creator
        ...
        .append(new ElementCreator("button").text("Remove").listener('click', () => {
            ...
            // <- This call removes the resource from the DOM. Call it after (and only if) your API call succeeds!
        }));
...
function edit(resource) {
    ...
    */
    ...
    let checkbox = new ElementCreator("input").id("resource-hasGreenEyes").with("type", "checkbox");
    if (resource.greeneyes){
    ...
    formCreator
        ...
        .append(new ElementCreator("label").text("GreenEyes").with("for", "resource-hasGreenEyes"))
        .append(checkbox);
    ...
    formCreator
        .append(new ElementCreator("button").text("Speichern").listener('click', (event) => {
            ...
            */
            ...
            resource.greeneyes = document.getElementById("resource-hasGreenEyes").checked;
        ...
        formCreator.replace(document.querySelector('main'), document.getElementById(resource.idforDOM));
}
 ...
 */
function create() {
    const resource = new Resource("","",true);


    const createButton = document.getElementById("createButton"); // Create button will be greyed
    createButton.setAttribute("disabled", "disabled");

    const formCreator = new ElementCreator("form")
        .id("NewResource")
        .append(new ElementCreator("h3").text("New"));
    ...
    */
    ...
    formCreator
        ...
        .insertBefore(document.querySelector("main"),document.getElementById("bottom"));
    formCreator.element.scrollIntoView();
}
